...
const modules = [
  ...
  {
    title: "เรือนยอดไม้ในเมือง",
    subtitle: "Tree Cover · Dynamic World",
    description: "สัดส่วนและพื้นที่เรือนยอดไม้รายเขต พร้อมติดตามการเพิ่มและสูญเสียเทียบปีฐาน",
    href: "/green-space",
    icon: Trees,
  ...
  },
  {
    title: "การขยายตัวของเมือง",
      subtitle: "Built-up Cover · Dynamic World",
      description: "สัดส่วนพื้นที่สิ่งปลูกสร้าง การเพิ่มและลด รวมถึงพื้นที่สีเขียวที่เปลี่ยนเป็นเมือง",
