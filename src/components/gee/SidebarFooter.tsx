...
import { Building2, ChevronRight, Droplets, Flame, Home, ShieldAlert, Trees } from "lucide-react";

export type NavKey = "home" | "traffy" | "heat-island" | "green-space" | "urban-expansion" | "flood-risk";
